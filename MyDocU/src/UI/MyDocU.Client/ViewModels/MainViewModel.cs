...
using MyDocU.Application.Interfaces.CQRS;
using MyDocU.Application.UseCases.Person;
using MyDocU.Application.UseCases.Person.Commands.Create;
using MyDocU.Application.UseCases.Person.Commands.Delete;
using MyDocU.Application.UseCases.Person.Commands.Update;
using MyDocU.Application.UseCases.Person.Queries.GetPerson;
